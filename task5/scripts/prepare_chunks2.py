...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=[
            Path("../task2/knowledge_base"),
            Path("./injections"),
        ],
        nargs="+",
        help="Один или несколько каталогов с md-файлами"
    )
    parser.add_argument(
...
def compute_overlap_tokens(prev_text: str, curr_text: str, tokenizer, max_overlap_chars: int = 1000) -> int:
    """
...
def main():
    ...
    docs_paths: list[Path]  = args.docs_path
    ...
    text_splitter = RecursiveCharacterTextSplitter(
        chunk_size=args.max_tokens - 20, # minus header tokens
