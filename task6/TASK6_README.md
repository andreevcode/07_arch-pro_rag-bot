...
## ADR: общие решения
1. База знаний (сами документы) в проекте будут храниться в локальной папке; в проде это, например, может быть локальное сетевое хранилище организации.
...
4. Логика обновления индекса:
   - по крону запускаемся, ищем изменения в файлах KB;
