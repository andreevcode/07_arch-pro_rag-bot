...
## Анализ результатов
Все метрики, а также исходники (логи, голден сеты) собраны для удобства в [task7/rag-monitor/_tests_results](rag-monitor/_tests_results).
...
### Оценка ответа найден/не найден
